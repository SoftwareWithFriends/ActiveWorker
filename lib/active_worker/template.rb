class Template
  ...
  has_and_belongs_to_many :child_templates,  :class_name => "Template", :inverse_of => :parent_templates
  has_and_belongs_to_many :parent_templates, :class_name => "Template", :inverse_of => :child_templates
